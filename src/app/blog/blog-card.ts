...
@Component({
  ...
  template: `
    <a
      ...
      class="group flex h-full flex-col rounded-xl border border-slate-200 p-6 transition-colors hover:border-accent-500/60 dark:border-ink-700 dark:bg-ink-900/50 dark:hover:border-accent-400/60"
    >
      ...
      <span
        class="mt-5 font-mono text-sm text-accent-600 dark:text-accent-400"
        aria-hidden="true"
      >
