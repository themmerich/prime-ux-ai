  ...
  template: `
    <section id="ueber-mich" class="border-t border-slate-200 dark:border-ink-800">
      <div class="mx-auto max-w-5xl px-6 py-20 md:py-28">
        ...
        <div class="max-w-3xl">
          <p class="text-lg leading-relaxed text-slate-700 md:text-xl dark:text-slate-200" pxReveal>
            {{ i18n.t(about.text) }}
          </p>
          <p class="mt-5 text-base leading-relaxed" pxReveal [pxRevealDelay]="0.1">
            {{ i18n.t(about.beyond) }}
          </p>

          <div class="mt-8 flex flex-wrap gap-2" pxReveal="stagger">
